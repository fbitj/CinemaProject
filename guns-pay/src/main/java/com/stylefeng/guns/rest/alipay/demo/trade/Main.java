...
import com.stylefeng.guns.rest.alipay.demo.trade.model.builder.*;
    ...
    public void test_trade_precreate() {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("D:\\Develop & Learning\\Project\\Project3\\pic/qr-%s.png",
